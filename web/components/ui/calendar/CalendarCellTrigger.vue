...
<template>
  <CalendarCellTrigger
    :class="cn(
      ...
      // Outside months
      'data-[outside-month]:pointer-events-none data-[outside-month]:text-zinc-500 data-[outside-month]:opacity-50 [&[data-outside-month][data-selected]]:bg-zinc-100/50 [&[data-outside-month][data-selected]]:text-zinc-500 [&[data-outside-month][data-selected]]:opacity-30 dark:data-[outside-month]:text-zinc-400 dark:[&[data-outside-month][data-selected]]:bg-zinc-800/50 dark:[&[data-outside-month][data-selected]]:text-zinc-400',
      props.class,
    )"
